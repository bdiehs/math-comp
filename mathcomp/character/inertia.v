...
From mathcomp Require Import mxrepresentation vector algC.
From mathcomp Require Import forms classfun character.
...
rewrite gt_eqF // (bigD1 b) //= linearZl_LR /= cfnorm_irr [_ *:_]mulr1 ltr_paddr ?egt0 //.
...
suffices: theta \in 'CF(K, L).
  rewrite -cfnorm_Res_leif // DthL dnormZ /=  !cfnorm_irr !mulr1 normr_nat.
